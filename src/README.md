...
| POST   | `/logout`                                                         | Log out the current teacher                                  |
...
Teacher credentials are stored in `teachers.json` for this exercise. Signup and unregister actions require a teacher session; activity listings remain public.
